...
def ResNet1D1111rfid(input_shape,hparams):
    input_c=input_shape[0]*input_shape[1]
    model = ResNet(block=BasicBlock, layers=[1, 1, 1, 1], inchannel=input_c)
    return model

def ResNet1D18rfid(input_shape,hparams):
    input_c=input_shape[0]*input_shape[1]
    model = ResNet(block=BasicBlock, layers=[2, 2, 2, 2], inchannel=input_c)
    return model

def ResNet1D50rfid(input_shape,hparams):
    input_c=input_shape[0]*input_shape[1]
    model = ResNet(block=BasicBlock, layers=[3, 4, 6, 3], inchannel=input_c)
    return model

def ResNet1D101rfid(input_shape,hparams):
    input_c=input_shape[0]*input_shape[1]
    model = ResNet(block=BasicBlock, layers=[3, 4, 23, 3], inchannel=input_c)
    return model
