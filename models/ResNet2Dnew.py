...
# =========================
def ResNet182DNew(input_shape, hparams):
    return ResNet2DNew(input_shape, hparams, block=Block, layer_list=[2, 2, 2, 2])

def ResNet18_mutual(input_shape, hparams):
    return ResNetLargeBert3(input_shape, hparams, block=Block, layer_list=[2, 2, 2, 2])

def ResNet342DNew(input_shape, hparams):
    return ResNet2DNew(input_shape, hparams, block=Block, layer_list=[3, 4, 6, 3])

def ResNet34_mutual(input_shape, hparams):
    return ResNetLargeBert3(input_shape, hparams, block=Block, layer_list=[3, 4, 6, 3])


def ResNet502DNew(input_shape, hparams):
    return ResNet2DNew(input_shape, hparams, block=Bottleneck, layer_list=[3, 4, 6, 3])

def ResNet50_mutual(input_shape, hparams):
    return ResNetLargeBert3(input_shape, hparams, block=Bottleneck, layer_list=[3, 4, 6, 3])

def ResNet1012DNew(input_shape, hparams):
    return ResNet2DNew(input_shape, hparams, block=Bottleneck, layer_list=[3, 4, 23, 3])

def ResNet101_mutual(input_shape, hparams):
    return ResNetLargeBert3(input_shape, hparams, block=Bottleneck, layer_list=[3, 4, 23, 3])

def ResNet11112DNew(input_shape, hparams):
    """ResNet18结构，4个Block残差层。"""
    return ResNet2DNew(input_shape, hparams, block=Block, layer_list=[1, 1, 1, 1])

def ResNet23462DNew(input_shape, hparams):
    """ResNet18结构，4个Block残差层。"""
    return ResNet2DNew(input_shape, hparams, block=Block, layer_list=[2, 3, 4, 6])
